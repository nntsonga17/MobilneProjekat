...
import elfak.mosis.cityexplorer.databinding.ActivityMyPlacesListBinding
...
class MyPlacesList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myPlacesList.adapter = ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, places)
